     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form id="addrentcarform" enctype="multipart/form-data" onsubmit="addrentcar(event)">
                    {{csrf_field()}}
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="payment" value="" placeholder="Enter Payment">
                          <p class="no-margin em"></p>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="capacity" value="" placeholder="Enter Number of Adult Persons">
                          <p class="no-margin em"></p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <button type="submit" class="btn btn-info btn-block form-control-lg">ADD CAR</button>
                      </div>
                    </div>
                  </form>
                </div>
...
function addrentcar(e) {
  ...
  var form = document.getElementById('addrentcarform');
